...
public class PassShooter extends Command {
  ...
  public PassShooter(ShooterSubsystem shooterSub, IntakeSubsystem intakeSub, boolean runIndex, double shooterPos, double shooterSpeed, boolean auto) {
  ...
  public void execute() {
    ...
    shooterSub.setFlyWheelVelocity(-6000);
