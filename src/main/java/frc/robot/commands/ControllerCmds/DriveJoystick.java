...
public class DriveJoystick extends Command {
   ...
   */
  public DriveJoystick(DriveSubsystem swerve, CommandXboxController driver, boolean fieldRelative) {
    this.swerve = swerve;
  ...
  public void execute() {
    ...
    yAxis = (Math.abs(yAxis) < ChassisConstants.deadband ? 0 : yAxis * 0.6);
    xAxis = (Math.abs(xAxis) < ChassisConstants.deadband ? 0 : xAxis * 0.6);
